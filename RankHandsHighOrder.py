            ...
            if card1.rank == 2:
                if card1.rank+3 == card2.rank+2 == card3.rank+1 == card4.rank:
                    if card1.suit == card2.suit == card3.suit == card4.suit == card5.suit:
                        ...
                        try:
                            straightValueToHandsDict[card4.rank].append(hand)
                        except:
                            straightValueToHandsDict[card4.rank] = [hand]
...
for hand in hands:
    ...
    if card1.rank == card2.rank == card3.rank:
        if card4.rank == card5.rank:
            try:
                fullHouseValueToHandsDict[card1.rank * 15 + card4.rank].append(hand)
            except:
                fullHouseValueToHandsDict[card1.rank * 15 + card4.rank] = [hand]
        ...
        if card1.rank+4 == card2.rank+3 == card3.rank+2 == card4.rank+1 == card5.rank:
            ...
            if card5.rank == 14:
                if card1.rank == 2:
                    if card1.rank+3 == card2.rank+2 == card3.rank+1 == card4.rank:
                        try:
                            straightFlushValueToHandsDict[card4.rank].append(hand)
                        except:
                            straightFlushValueToHandsDict[card4.rank] = [hand]
...
print "Writing to highOrderedHands.txt"
File = open("highOrderedHands.txt", "w")
